...
exxcellent.model.RowSelection = Core.extend({  
            ...
            toJsonStr : function() {
              return JSON.stringify( {rowSelection : {asr: this.asr, osr: this.osr, nsr: this.nsr, nur: this.nur}} );
            },
...
//                alert('renderDispose');
            ...
            renderUpdate: function(update) {                
                ...
                //alert('renderUpdate: ' + updatedProperties);                
            ...
            _onChangePage : function(pageNo) {             
                // notify listeners
                this.component.doChangePage(pageNo);
            },
