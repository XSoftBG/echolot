 ...
 */
public class ResultsPerPageOption implements Serializable {
    ...
    public boolean equals(Object obj) {
      ...
      final ResultsPerPageOption other = (ResultsPerPageOption) obj;
      if (!Arrays.equals(this.pageOptions, other.pageOptions)) {
          return false;
      }
      if (this.initialOption != other.initialOption) {
          return false;
      }      
      return true;
    }
