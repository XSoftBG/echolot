/*
 * This file (FlexiColumnVisibility.java) is part of the Echolot Project (hereinafter "Echolot").
 ...
 * @author oliver
 */
public class FlexiColumnVisibility {
     ...
     */
    public FlexiColumnVisibility(int columnId, boolean visible) {
