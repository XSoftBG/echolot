/*
 * This file (FlexiRow.java) is part of the Echolot Project (hereinafter "Echolot").
...
public class FlexiRow implements Serializable {
    ...
    public FlexiCell[] getCells() {
        return cells;
    }
    
    public FlexiCell getCellAt(int columnIndex) {
        try {
            return cells[columnIndex];
        }
        catch(IndexOutOfBoundsException ex) {
            throw new Error("Wrong columnIndex!");
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        final FlexiRow other = (FlexiRow) obj;
        if (this.id != other.id) {
            return false;
        }
