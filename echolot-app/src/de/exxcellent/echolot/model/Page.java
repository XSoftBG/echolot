...
public class Page implements Serializable{
  ...
  /**
     * Returns the rows' ids containing in this page.
     * 
     * @return the rows of the {@link Page}.
     */
	public Integer[] getRowsIds() {
		Integer[] result = new Integer[rows.length];
    for(int i = 0; i < rows.length; i++)
      result[i] = rows[i].getId();
    return result;
	}
  ...
  public boolean equals(Object obj)
  {
    if(obj == null || obj.getClass() != this.getClass())
      return false;
    Page cmp_page = (Page) obj;
    return this.page == cmp_page.page &&
           this.total == cmp_page.total &&
           Arrays.equals(this.rows, cmp_page.rows);
  }
}
